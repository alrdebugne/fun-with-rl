"""
Copying spinningup's Logger and EpochLogger classes.
Some simplifications:
- Only log run-related statistics (e.g. but no model saving here)
- Removed Tensorflow compatibility
- Removed MPI calculations (i.e. running only for single process for now)
